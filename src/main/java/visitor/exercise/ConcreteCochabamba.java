...
public class ConcreteCochabamba implements ICiudad {
    ...
    public ConcreteCochabamba(String nombre, int numeroProvincias, int numeroHabitantes, String clima, int dineroTurismo) {
        this.nombre = nombre;
    ...
    public void showInfo() {
        System.out.println("----------------------------USTED SE ENCUENTRA EN COCHABAMBA--------------------------------------");
